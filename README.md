...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-13 14:08`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/144a3f76-78a9-4f54-b5d2-11a456e67ef1.git
$ cd 144a3f76-78a9-4f54-b5d2-11a456e67ef1
```
